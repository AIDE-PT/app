        ...
        >
            ...
            <View className="flex-col items-end justify-center py-2 ml-4 gap-2">
                ...
                <View className="items-end gap-1">
                    <View className="flex-row items-baseline">
                        <Text className="text-4xl font-bold text-[#FF5252] font-open-sans-semibold">{max}</Text>
                        <Text className="text-lg font-medium text-[#FF5252] ml-1">{unit}</Text>
                    </View>
                ...
                <View className="items-end gap-1">
                    <View className="flex-row items-baseline">
                        <Text className="text-4xl font-bold text-[#4ade80] font-open-sans-semibold">{min}</Text>
                        <Text className="text-lg font-medium text-[#4ade80] ml-1">{unit}</Text>
                    </View>
