...
const ComponentItem = ({ label, children, dark = false }: { label: string; children: React.ReactNode; dark?: boolean }) => (
    <View className={`p-4 rounded-xl ${dark ? 'bg-[#1A1A2E]' : 'bg-white/80'}`}>
        <Text className={`font-open-sans text-[12px] ${dark ? 'text-white/60' : 'text-[#9CA3AF]'} mb-2 uppercase tracking-wider`}>
            {label}
        </Text>
        {children}
    </View>
                    ...
                    <ComponentSection title="Icons">
                        <ComponentItem label="SVG Icons">
                            <View className="flex-row flex-wrap gap-4 items-center">
                                <View className="items-center">
                                    <AddIcon />
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">AddIcon</Text>
                                </View>
                                <View className="items-center">
                                    <AideIcon />
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">AideIcon</Text>
                                </View>
                                <View className="items-center">
                                    <CalendarIcon />
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">CalendarIcon</Text>
                                </View>
                                <View className="items-center">
                                    <HomeIcon />
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">HomeIcon</Text>
                                </View>
                                <View className="items-center">
                                    <ProfileIcon />
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">ProfileIcon</Text>
                                </View>
                            </View>
                        </ComponentItem>
                        ...
                        <ComponentItem label="WidgetIcon - Variants">
                            <View className="flex-row flex-wrap gap-4 items-center justify-center">
                                <View className="items-center">
                                    ...
                                    <Text className="text-[10px] text-[#9CA3AF] mt-1">heartRate</Text>
                                </View>
                                <View className="items-center">
