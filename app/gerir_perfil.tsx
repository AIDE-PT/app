    ...
    <SafeAreaView className="flex-1 bg-[#F5F9FF]">
      ...
      >
        ...
        <View className="flex-row items-center px-6 py-4">
          ...
          <Text className="text-3xl font-bold ml-2 text-[#111]">Gerir Perfil</Text>
        </View>
        ...
        <View className="px-6 mb-2">
          ...
          <View className="flex-row justify-between items-center mt-6 mb-2">
            <Text className="text-lg font-bold text-[#111]">A SUA IDENTIFICAÇÃO</Text>
            {!isEditing && (
        ...
        <View className="px-6 mt-10">
          <View className="bg-[#E2E8F0] p-6 rounded-[32px] mb-4">
            ...
            <Text className="text-xs font-bold text-gray-800 mt-1">Ao apagar a sua conta todos os dados vão ser perdidos no espaço de 30 dias.</Text>
          ...
          <View className="bg-[#E2E8F0] p-6 rounded-[32px]">
            ...
            <Text className="text-xs font-bold text-gray-800 mt-1">Pedir dados que a AIDE têm sobre ti, desde a sua criação de conta em formato XML.</Text>
            <TouchableOpacity className="bg-[#CBD5E1] mt-4 py-3 rounded-full items-center w-36 self-center">
