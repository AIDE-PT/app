...
const heartRateData = [72, 85, 78, 92, 88, 75, 82, 90, 85, 78, 72, 80, 88, 75, 82, 79, 85, 90, 72, 78];
            ...
            <View className="px-4 mb-6">
                ...
                >
                    {days.map((item) => (
                        ...
                        >
                            <Text className={`text-xs font-open-sans mb-1 ${
                                selectedDay === item.day ? 'text-white/70' : 'text-gray-400'
                            }`}>
                                {item.weekday}
                            </Text>
                            <Text className={`text-xl font-bold font-open-sans ${
