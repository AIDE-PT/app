            ...
            >
              ...
              <View className="mb-6 mt-4">
                <Paragraph isDark={isDark}>
                  ...
                  apenas para fins de protótipo e demonstração e não constituem
                  um acordo juridicamente vinculativo.
                </Paragraph>
                <Paragraph isDark={isDark}>
                  Ao acessar ou usar este protótipo, você reconhece e concorda
                  com o seguinte:
                </Paragraph>
              </View>
              ...
              >
                ...
                <BulletPoint isDark={isDark}>
                  Não envie informações sensíveis, confidenciais ou que permitam
              ...
              >
                <Paragraph isDark={isDark}>
                  Estes Termos podem ser modificados a qualquer momento para
                  fins de teste ou iteração. O uso contínuo do protótipo
                  constitui aceitação de quaisquer termos simulados atualizados.
                </Paragraph>
              </TermSection>
